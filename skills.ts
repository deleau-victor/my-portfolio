	...
	Categories: [
		{
			Langages: [
				...
				{
					name: "Dart",
					icon: "/images/icons/Dev Skills/dart.svg",
					skills: ["Widgets", "Classes", "Gestions des états"],
				},
				{
					name: "PHP",
		...
		},
		{
			"Front-End": [
				...
				{
					name: "Vue JS",
					icon: "/images/icons/Frameworks Front/vue.svg",
					skills: ["Vue Router", "Gestions des états", "Composants"],
				},
			],
		},
		{
			"Back-End": [
				...
				{
					name: "Symfony",
					icon: "/images/icons/Frameworks Back/symfony.svg",
					skills: [
						"Création d'API Rest",
						"CORS avec Nelmio",
						"Modèle MVC",
